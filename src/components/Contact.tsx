        ...
        <div className="mb-16">
          ...
          <FadeInUp delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-4 sm:items-center">
              <a href="mailto:business@studio.com" className="inline-flex items-center gap-2 text-sm font-semibold tracking-wider text-accent hover:opacity-80 transition-opacity">
